...
@section('content')
<h1 class="page-header">محتوى صفحة (من نحن؟)</h1>
  ...
  <form action="{{ route('admin.aboutus.update') }}" method="POST">
    ...
    <div class="flex flex-col gap-7 m-1 md:m-7 py-7 px-15 bg-white shadow-lg rounded-xl border border-gray-100">
      ...
      <div class="flex items-center gap-3">
        <button class="bg-teal-600 hover:bg-teal-700 text-white px-6 py-2 rounded-lg font-medium shadow-sm transition hover:cursor-pointer">
          💾 حفظ
        </button>
